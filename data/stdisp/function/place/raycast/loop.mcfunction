...
execute positioned ^ ^ ^ if block ~ ~ ~ #stdisp:heads{profile:{name:"$stdisp.display"}} align xyz positioned ~0.5 ~0.5 ~0.5 run function stdisp:place/raycast/hit
execute positioned ^1 ^ ^ if block ~ ~ ~ #stdisp:heads{profile:{name:"$stdisp.display"}} align xyz positioned ~0.5 ~0.5 ~0.5 run function stdisp:place/raycast/hit
execute positioned ^-1 ^ ^ if block ~ ~ ~ #stdisp:heads{profile:{name:"$stdisp.display"}} align xyz positioned ~0.5 ~0.5 ~0.5 run function stdisp:place/raycast/hit
execute positioned ^ ^1 ^ if block ~ ~ ~ #stdisp:heads{profile:{name:"$stdisp.display"}} align xyz positioned ~0.5 ~0.5 ~0.5 run function stdisp:place/raycast/hit
execute positioned ^ ^-1 ^ if block ~ ~ ~ #stdisp:heads{profile:{name:"$stdisp.display"}} align xyz positioned ~0.5 ~0.5 ~0.5 run function stdisp:place/raycast/hit
execute positioned ^2 ^ ^ if block ~ ~ ~ #stdisp:heads{profile:{name:"$stdisp.display"}} align xyz positioned ~0.5 ~0.5 ~0.5 run function stdisp:place/raycast/hit
execute positioned ^-2 ^ ^ if block ~ ~ ~ #stdisp:heads{profile:{name:"$stdisp.display"}} align xyz positioned ~0.5 ~0.5 ~0.5 run function stdisp:place/raycast/hit
execute positioned ^ ^2 ^ if block ~ ~ ~ #stdisp:heads{profile:{name:"$stdisp.display"}} align xyz positioned ~0.5 ~0.5 ~0.5 run function stdisp:place/raycast/hit
execute positioned ^ ^-2 ^ if block ~ ~ ~ #stdisp:heads{profile:{name:"$stdisp.display"}} align xyz positioned ~0.5 ~0.5 ~0.5 run function stdisp:place/raycast/hit
